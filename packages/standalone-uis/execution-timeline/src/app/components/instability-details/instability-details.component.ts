...
export class InstabilityDetailsComponent implements OnChanges, OnInit, OnDestroy {
  @Input()
  public segment: any;
  ...
  public startTimeInMillseconds: number;
  ...
  public ngOnChanges(changes: SimpleChanges): void {
    ...
    this.startTimeInMillseconds = round2(this.segment.startPerformanceStamp);
