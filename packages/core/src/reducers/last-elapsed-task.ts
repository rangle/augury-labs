    ...
    if (prevRootTask && !nextRootTask) {
      return {
        result: {
          ...
          startEventId: prevRootTask.startEventId,
          startTimestamp: prevRootTask.startTimestamp,
    ...
    if (prevNgTask && !nextNgTask) {
      return {
        result: {
          ...
          startEventId: prevNgTask.startEventId,
          startTimestamp: prevNgTask.startTimestamp,
          endTimestamp: nextEvent.creationAtTimestamp,
          flamegraph: updatedFlamegraph,
          drag,
        },
