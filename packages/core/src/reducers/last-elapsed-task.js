...
const current_root_zone_task_1 = require('./current-root-zone-task')
...
class LastElapsedTaskReducer extends reducers_1.Reducer {
  constructor() {
    super(...arguments)
    this.dependencies = {
      currentRootTask: new current_root_zone_task_1.CurrentRootZoneTaskReducer(),
      currentNgTask: new current_ng_zone_task_1.CurrentNgZoneTaskReducer(),
    }
  }
  deriveShallowState({ prevShallowState = INIT_STATE, nextEvent, nextDepResults, prevDepResults }) {
    ...
    const {
      currentRootTask: { task: nextRootTask, startTime: nextRootStartTime } = {},
      currentNgTask: { task: nextNgTask, startTime: nextNgStartTime } = {},
    } = nextDepResults
...
exports.LastElapsedTaskReducer = LastElapsedTaskReducer
...
function updateFlamegraph(prevFlameGraph = [], e /* augury event */) {
...
//# sourceMappingURL=last-elapsed-task.js.map
